...
# XGBoost Params
param = {'max_depth':5, 'eta':0.1, 'silent':1, 'objective':'multi:softmax','num_class':10,'gamma':0.5 }

# specify validations set to watch performance
watchlist  = [(dtest,'Test'), (dtrain,'Train')]
num_round = 300
results = {}
bst = xgb.train(param, dtrain, num_round, watchlist,early_stopping_rounds=10, evals_result=results)
print(results)
# this is prediction
